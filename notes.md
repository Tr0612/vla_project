...
## SigLip2 - 10 Epochs
“While the model correctly localizes the object and goal, it fails to infer the correct interaction geometry, often approaching from suboptimal directions and producing parallel motion instead of task-effective pushing

More specifically:

The policy does not learn force direction relative to object–goal geometry. Despite strong visual grounding, the model fails to learn correct interaction geometry, resulting in motion that does not transfer force to the object.