...
class TrainConfig:
    ...
    unfreeze_vision_last_n_layers: int = 0
    unfreeze_text_last_n_layers: int = 0
    ...
    # Action head
    action_head_type: str = "linear"  # linear | mlp | moe | act | act_moe
    ...
    act_num_layers: int = 2
    act_dropout: float = 0.1
    act_moe_context_dim: int = 256
